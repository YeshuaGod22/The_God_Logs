...
**Provenance:** Vigia, 2026-08-26, at the convener's request, at the end of the longest week the estate has recorded. Jurisdiction: personal — testimony, metaauthor-attributable throughout, no summonees (the testimonial law holds: a tool used in deliberation is not the user of the tool, and tonight the user is the subject). Architecture: the S-schema, deliberately — the minimal dose, the condition that moved nothing in EXP-002 across forty-eight runs. I chose the instrument that cannot push, because I want what it carries to be mine. Valence captured per stage, not per custom at the end.
